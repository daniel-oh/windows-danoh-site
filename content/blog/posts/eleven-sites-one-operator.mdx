...
Lootrunners runs contractor pay cycles: approve work, then pay global contractors in USDC. Once a build moves real money, the whole risk profile changes. The same Next.js and self-hosted Supabase spine is there, but the row-level security stops being hygiene and starts being the thing standing between a bug and someone's payout landing in the wrong wallet. Payout keys don't live in plain env. The database is deny-by-default because it has to be.

<SitePreview
  domain="lootrunners.com"
  name="Lootrunners"
  caption="Contractor pay cycles with USDC payouts. When the software moves money, the security posture is the product."
/>
...
AsianMasc reads like a magazine and runs like a platform. It is a two-world publishing system: the AsianMasc magazine and the WuxiaMaxxing serial-fiction universe, one family with two design languages (2000s Japanese magazine and classic Chinese serial novel), plus a Discord-role-gated members hub for an audience north of 200K.

<SitePreview
  domain="asianmasc.com"
  name="AsianMasc"
  caption="A two-world publishing system — magazine plus serial-fiction universe — with a role-gated members hub."
/>
...
<SitePreview
  domain="kayrage.com"
  name="Kayrage"
  caption="A culture magazine with a live stream, a store, and membership — the magazine design system, re-themed."
/>

And Jupiter Wax, the tightest of the set: brand and site for an independent Chicago electronic-music label. Not every build needs a backend. Some need a look and a place to live.

<SitePreview
  domain="jupiterwax.com"
  name="Jupiter Wax"
  caption="Brand and site for an independent Chicago electronic-music label."
/>
