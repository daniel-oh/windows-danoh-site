...
Floeberg works there. Three scoped engagements, two weeks each, fixed price, public scope, written deliverable. The catalog lives at [floeberg.com/audits](https://floeberg.com/audits).
...
(For the build log side of the Floeberg launch — the actual stack, the trade-offs, the things that took two days when they should have taken fifteen minutes — see [Building Floeberg](/blog/building-floeberg).)
